...
uses Classes, Types, SysUtils, Math;

type
   TODEFunction = procedure (time : double; y, dydt : TDoubleDynArray) of object;
   ...
   TRK45 = class (TObject)
     ...
     public
       procedure RKF45(Y, Yp         : TDoubleDynArray;
                var T                : double;
...
var
  ...
  kop         : Integer = -1;
  nfe         : Integer = -1;
  relerr_save : double   = -1.0;
  abserr_save : double   = -1.0;
  h           : double   = -1.0;
  f1          : TDoubleDynArray = nil;
  f2          : TDoubleDynArray = nil;
  f3          : TDoubleDynArray = nil;
  f4          : TDoubleDynArray = nil;
  f5          : TDoubleDynArray = nil;

procedure Fehl(F                         : TODEFunction;
               Neqn                      : Integer;
               Y                         : TDoubleDynArray;
               T, H                      : double;
               Yp, F1, F2, F3, F4, F5, S : TDoubleDynArray);
{ ------------------------------------------------------------------
...
procedure RKF45(F                    : TODEFunction;
                Neqn                 : Integer;
                Y, Yp                : TDoubleDynArray;
                var T                : double;
                Tout, RelErr, AbsErr : double;
                var Flag             : Integer);
{ ------------------------------------------------------------------
...
var
  k, mflag                                   : Integer;
  ae, dt, ee, eeoet, esttol, et              : double;
  hmin, relerr_min, s, scale, tol, toln, ypk : double;
  hfaild, outp                               : Boolean;
